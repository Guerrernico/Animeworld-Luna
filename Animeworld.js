...
async function extractEpisodes(url) {
  try {
    ...
    // Genera la lista dinamica che l'app leggerÃ  autonomamente
...
// Ã¢ÂÂ Ã¯Â¸Â DO NOT EDIT BELOW THIS LINE Ã¢ÂÂ Ã¯Â¸Â
...
async function doodstreamExtractor(html, url = null) {
    ...
    const hash = match[1];
    const token = match[2];
    console.log('Ã°ÂÂÂ Hash:', hash, 'Token:', token);
    ...
    console.log('Ã°ÂÂÂ¬ Base video URL:', baseUrl);
    // 3. Replicate makePlay() Ã¢ÂÂ random 10 chars + token + expiry
